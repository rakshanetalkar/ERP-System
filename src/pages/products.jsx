  ...
  return (
    <>
      <div className="container mx-auto p-4">
        ...
        <h2 className="text-2xl font-bold mb-4 text-center bg-clip-text text-transparent bg-cyan-500">Products Management</h2>
        <button
          type="button"
          className="my-4 inline-flex w-full justify-center rounded-md bg-green-500 px-4 py-2 text-sm 
          font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-green-600 
          sm:mt-0 sm:w-auto focus:outline-none"
            ...
            <tbody>
              {products.map((product) => (
                <tr key={product.id} className="hover:bg-gray-100">
                  ...
                  <td className="py-2 px-4 border flex md:flex-row justify-center gap-2">
                    <button
                      className="bg-blue-500 text-white px-2 py-1 m-1
                       rounded hover:bg-blue-700 flex items-center gap-2 w-fit h-fit"
                      onClick={() => handleEditProduct(product)}
                      ref={editRef}
                    >
                      <PencilIcon className="h-7 w-7 md:h-4 md:w-4" />
                      Edit
                    </button>
                    <button
                      className="bg-red-500 text-white px-2 py-1 m-1 
                       rounded hover:bg-red-700 flex items-center gap-2 w-fit h-fit"
                      onClick={() => handleDeleteProduct(product.id)}
                    >
                      <TrashIcon className="h-7 w-7 md:h-4 md:w-4" />
                      Delete
                    </button>
                  </td>
                </tr>
